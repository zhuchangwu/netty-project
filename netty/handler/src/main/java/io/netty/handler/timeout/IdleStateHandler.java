...
/**
 *  todo 在一段时间内，channel中即没有读， 也没有写，也没有读写， 就会触发用户事件
...
public class IdleStateHandler extends ChannelDuplexHandler {
    ...
    public IdleStateHandler(
            int readerIdleTimeSeconds,// todo 读的时间 ： 在这个时间内没有发生 读， 则触发用户事件
            int writerIdleTimeSeconds,// todo 写的时间 ： 在这个时间内没有发生 写， 则触发用户事件
            int allIdleTimeSeconds) {// todo 读写的时间： 在这个时间内没有发生 读写， 则触发用户事件
