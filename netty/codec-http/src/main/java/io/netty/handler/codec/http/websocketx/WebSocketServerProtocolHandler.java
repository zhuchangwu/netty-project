 ...
 * todo 这个处理器可以帮助你处理所有的繁重的工作, 使你可以运行一个WebSocket
 *
 ...
 * todo 它关注WebSocket的握手, 以及对 frames的控制, 如关闭,ping pong,
 * todo  它会将文本信息或者是二进制的数据帧传递到 程序员自定义的处理器中进行进一步处理
 *
 * todo 其中, 对WebSocket来说,数据的传递格式是 frames,
 * todo 有如下六种帧
 * todo  1. BinaryWebSocketFrame
 * todo  2. CloseWebSocketFrame
 * todo  3. ContinuationWebSocketFrame
 * todo  4. PingWebSocketFrame
 * todo  5. PongWebSocketFrame
 * todo  6. TextWebSocketFrame
 *
