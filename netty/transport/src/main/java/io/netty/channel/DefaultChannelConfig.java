 ...
 */
// todo  是ChannelConfig的一种默认的实现, 里面配置 默认的channel 常量的配置信息
public class DefaultChannelConfig implements ChannelConfig {
    ...
    // todo 此时的channel依然为 NioServerSocketChannel
    public DefaultChannelConfig(Channel channel) {
        // todo 调用本类的另一个构造函数 , 关注: AdaptiveRecvByteBufAllocator  创建了一个可适配的接受字节缓冲的适配器
